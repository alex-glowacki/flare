...
void MPU_Config(void)
{
    ...
    /* Region 0: block entire 4GB address space, no access (background region) */
    ...
    /* Region 1: AXI SRAM (0x24000000, 512KB region covers 320KB)
     * Write-through cached, DMA accessible — required for DSHOT DMA buffer */
    MPU_InitStruct.Enable             = MPU_REGION_ENABLE;
