...
#define FLARE_PACKET_DATA_LEN   13U     /* bytes covered by CRC (everything but checksum) */
...
typedef struct __attribute__((packed)) {
    ...
    uint8_t mode;           /* FLARE_MODE_ANGLE / FLARE_MODE_ACRO */
...
_Static_assert(sizeof(FLARE_RC_Packet_t) == FLARE_PACKET_SIZE, "FLARE_RC_Packet_t size mismatch - check for padding");
